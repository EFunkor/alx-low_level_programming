 ...
 * Return: The sorted hash table or NULL on error
 */
...
/**
 * shash_table_set - A functgion that adds an element to a sorted hash table.
 ...
 * Return: the value associated with key in ht or NULL if key can't be found.
 */
